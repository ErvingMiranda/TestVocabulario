...
In TestVocabulario-labels_en.properties:
TestVocabulario=My application
TestVocabulario[description]=My application does this and that

In TestVocabulario-messages_en.properties:
